...
class Transport extends BaseModel {
     ...
     */
    public function calcTransport($transport_id,$count=1,$weight=0) {
        ...
        if (empty($extend_list) || !$transport) {
            ...
            return $this->_calc_unit($transport, $extend_list,$count,$weight);
        }
    }
     ...
     * @return type
     */
    private function _calc_unit($transport,$extend, $count,$weight) {
