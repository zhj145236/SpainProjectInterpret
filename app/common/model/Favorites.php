...
class Favorites extends BaseModel
{
     ...
     * @return array
     */
    public function getMobileFavoritesList($condition, $field = '*', $pagesize = 0, $limit = 0, $order = 'favlog_id desc')
    {
        return Db::name('favorites')->where($condition)->field($field)->page($pagesize,$limit)->order($order)->select()->toArray();
    }
