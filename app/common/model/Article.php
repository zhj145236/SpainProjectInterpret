...
class Article extends BaseModel
{
     ...
     * @return type
     */
    public function getMobileArticleList($condition, $field = '*', $pagesize = 0, $limit = 0, $order='article_sort asc,article_time desc'){
        
        return Db::name('article')->field($field)->where($condition)->page($pagesize,$limit)->order($order)->select()->toArray();
    }
