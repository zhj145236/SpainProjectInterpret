...
class Buy
{
    ...
    private function _createOrderStep3()
    {
        ...
        $store_freight_total = $this->_logic_buy_1->calcStoreFreight($freight_list);
    ...
    private function _createOrderStep4()
    {
        ...
        //         $v = 'online';
        // }
        $payment_type = $this->_order_data['input_pay_name'];
        ...
        foreach ($store_cart_list as $store_id => $goods_list) {
            ...
            $order['payment_code'] = $payment_type;
            $order['order_state'] = $payment_type == 'offline' ? ORDER_STATE_PAY : ORDER_STATE_NEW;
     ...
     */
    public function _getGoodsList($cart_list)
    {
     ...
     * @return array
     */
    public function _getStoreCartList($cart_list)
    {
        if (empty($cart_list) || !is_array($cart_list))
            return $cart_list;
        $new_array = array();
