...
$lang['predeposit_adminremark']				= '备注';
...
$lang['predeposit_pricetype_available']		= '可用余额';
$lang['predeposit_pricetype_freeze']		= '冻结金额';
$lang['predeposit_price']					= '金额';
$lang['predeposit_payment_error']			= '支付方式错误';
$lang['predeposit_recordimgs']				= '转账截图';
$lang['predeposit_recordimgs_upload']		= '图片上传';
$lang['predeposit_copy']					= '点击复制';
$lang['predeposit_copy_success']			= '复制成功';
/**
 * 充值功能公用
 */
...
$lang['predeposit_rechargepaysuccess']			= '已充值';
...
$lang['predeposit_recharge_pay_offline']		= '待平台确认';
$lang['predeposit_recharge_zhuanzhangbank']		= '收款银行';
$lang['predeposit_recharge_selectbank']			= '选择汇款银行';
$lang['predeposit_recharge_delimgs']			= '删除图片';
/**
 * 充值添加
 */
$lang['predeposit_recharge_add_pricenull_error']			= '请添加充值金额';
$lang['predeposit_recharge_add_pricemin_error']				= '充值金额为大于或者等于0.01的数字';
$lang['predeposit_recharge_add_hint']						= '<span style="color:orange;">转账截图上传，请保证截图清晰且包含转账银行流水号、转账银行、转账金额、转账时间等重要信息。</span>';
$lang['predeposit_recharge_selectbank_hint']				= '<span style="color:orange;">选择汇款银行，点击之后将跳转到对应银行官网进行转账，若无可选择银行，请自行处理转账。</span>';
$lang['predeposit_recharge_recordimgs_null']				= '请上传转账截图';
/**
 * 充值信息删除
 */
