...
class Cart extends BaseMember {
    ...
    function add() {
        ...
        if($goods_info['goods_ispifa']>0){
        	if($goods_info['startnum1'] <= $quantity && $quantity <= $goods_info['endnum1']){
        		$goods_info['goods_price'] = $goods_info['pifaprice1'];
        	}else if($goods_info['startnum2'] <= $quantity && $quantity <= $goods_info['endnum2']){
        		$goods_info['goods_price'] = $goods_info['pifaprice2'];
        	}else if($goods_info['startnum3'] <= $quantity && $quantity <= $goods_info['endnum3']){
