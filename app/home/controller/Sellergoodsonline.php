...
class Sellergoodsonline extends BaseSeller {
    ...
    public function edit_goods() {
        ...
        $goods_pifainfo = $goods_model->getGoodsPifaInfo(array(array('goods_id', '=', $common_id)));
        ...
        View::assign('goods_pifainfo', $goods_pifainfo);
    ...
    public function edit_save_goods() {
        ...
        //是否批发
        $update_common['goods_ispifa'] = intval(input('post.is_pifa'));
        ...
        try {
            ...
            if (is_array($spec_array) && !empty($spec_array)) {
                ...
                if (!empty($goods_info)) {
                    ...
                    $update['goods_ispifa'] = $update_common['goods_ispifa'];
                    ...
                    $insert['goods_ispifa'] = $update_common['goods_ispifa'];
                ...
                if(!empty($common_id) && $update_common['goods_ispifa']>0){
                	
                	$goods_pifainfo = $goods_model->getGoodsPifaInfo(array(array('goods_id', '=', $common_id)));
                	
                	$updte_pifa = array();
                	$updte_pifa['goods_id'] = $common_id;
                	$updte_pifa['startnum1'] = intval(input('post.g_startnum1'));
                	$updte_pifa['endnum1'] = intval(input('post.g_endnum1'));
                	$updte_pifa['pifaprice1'] = floatval(input('post.g_pifaprice1'));
                	$updte_pifa['startnum2'] = intval(input('post.g_startnum2'));
                	$updte_pifa['endnum2'] = intval(input('post.g_endnum2'));
                	$updte_pifa['pifaprice2'] = floatval(input('post.g_pifaprice2'));
                	$updte_pifa['startnum3'] = intval(input('post.g_startnum3'));
                	$updte_pifa['endnum3'] = intval(input('post.g_endnum3'));
                	$updte_pifa['pifaprice3'] = floatval(input('post.g_pifaprice3'));
                	
                	if(!empty($goods_pifainfo)){
                		$goods_model->editGoodsPifa($updte_pifa, $common_id);
                	}else{
                		$goods_model->addGoodsPifa($updte_pifa);
                	}
                }
