		...
		<div class="container">
			<div class="header" style="margin:20px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a target = "_blank" href="http://xbyshopp.stablenewpay.com/">DsMall开源商城官网</a></li>
					<li role="presentation"><a target = "_blank" href="http://bbs.stablenewpay.com/">访问论坛</a></li>
				</ul>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a  target = "_blank" href="http://xbyshopp.stablenewpay.com">DsMall开源商城官网</a> &nbsp; &nbsp; <a  target = "_blank" href="http://bbs.stablenewpay.com/">DsMall开源商城论坛</a> &nbsp; &nbsp; <a target = "_blank" href="http://xbyshopp.stablenewpay.com">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a   target = "_blank" href="http://xbyshopp.stablenewpay.com"><b>DsMall开源商城</b></a> {$curent_version} B2B2C &copy; 2012-2027 <a target = "_blank" href="http://xbyshopp.stablenewpay.com">www.stablenewpay.com</a>
				</div>
			</div>
		</div>
		<script src="../static/plugins/jquery-2.1.4.min.js"></script>
