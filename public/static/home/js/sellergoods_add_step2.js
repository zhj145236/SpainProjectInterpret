$(function(){
    ...
    $('.sgcategory').unbind().change( function(){
        ...
        // 验证是否已经选择
        if (!checkSGC(_val)) {
            alert('Esta categoría ya está seleccionada, por favor seleccione otra categoría');
            return false;
        }
        $(this).val(_val);              // 重新赋值
    });
    ...
    $('div[dstype="mobile_pannel"]').on('click', '[dstype="mp_edit"]', function(){
        ...
        $(this).parents('.module:first').html('')
            ...
            .find('textarea[dstype="meat_content"]').unbind().charCount({
                ...
                firstCounterText:   'También puede introducir',
                endCounterText:     'Palabra',
                errorCounterText:   'Ha superado'
            });
    });
    // 编辑提交
    $('div[dstype="mobile_pannel"]').on('click', '[dstype="meat_edit_submit"]', function(){
        ...
        _parents.html('').append('<div class="tools"><a dstype="mp_up" href="javascript:void(0);">Subir</a><a dstype="mp_down" href="javascript:void(0);">Bajar</a><a dstype="mp_edit" href="javascript:void(0);">Editar</a><a dstype="mp_del" href="javascript:void(0);">Borrar</a></div>')
    ...
    $('div[dstype="mobile_pannel"]').on('click', '[dstype="meat_edit_cancel"]', function(){
        ...
        _parents.html('').append('<div class="tools"><a dstype="mp_up" href="javascript:void(0);">上移</a><a dstype="mp_down" href="javascript:void(0);">下移</a><a dstype="mp_edit" href="javascript:void(0);">Editar</a><a dstype="mp_del" href="javascript:void(0);">Borrar</a></div>')
        .append('<div class="content"><div class="text-div">' + _c + '</div></div>')
        .append('<div class="cover"></div>');
    });
    // 初始化控制面板
    ...
    $('a[dstype="meat_submit"]').click(function(){
        ...
        $('<div class="module m-text"></div>')
            .append('<div class="tools"><a dstype="mp_up" href="javascript:void(0);">Subir</a><a dstype="mp_down" href="javascript:void(0);">Bajar</a><a dstype="mp_edit" href="javascript:void(0);">Editar</a><a dstype="mp_del" href="javascript:void(0);">Borrar</a></div>')
            .append('<div class="content"><div class="text-div">' + _c + '</div></div>')
    ...
    insert_mobile_img = function(data){
        ...
        $('<div class="module m-image"></div>')
            .append('<div class="tools"><a dstype="mp_up" href="javascript:void(0);">Subir</a><a dstype="mp_down" href="javascript:void(0);">Bajar</a><a dstype="mp_rpl" href="javascript:void(0);">Reemplazar</a><a dstype="mp_del" href="javascript:void(0);">Borrar</a></div>')
    ...
    mDataSet = function(data){
        ...
        $.each(data, function(i, n){
            if (n.type == 'image') {
                _i_c += 1;
                if (_i_c > _i_c_m) {
                    alert('Sólo puede elegir '+_i_c_m+'Imagen');
                    _sign = false;
                    return false;
                }
            } else if (n.type == 'text') {
                _t_c += n.value.length;
                if (_t_c > _t_c_m) {
                    alert('Sólo se puede introducir '+_t_c_m+'Caracteres');
                    _sign = false;
                    return false;
                }
            }
        ...
        $('span[dstype="img_count_tip"]').html('También puede seleccionar imágenes <em>' + (_i_c_m - _i_c) + '</em>Zhang');
        $('span[dstype="txt_count_tip"]').html('También puede introducir <em>' + (_t_c_m - _t_c) + '</em>Palabra');
