$(function(){
	...
	TransTpl += "Flete predeterminado：\n";
	TransTpl += "<input class=\"w30 mr5 text\" type=\"text\" aria-label=\"Número predeterminado de envíos\" maxlength=\"4\" autocomplete=\"off\" data-field=\"start\" value=\"1\" name=\"default[TRANSTYPE][start]\">\n";
	TransTpl += "<span class=\"content_1\">件</span>内，\n";
	TransTpl += "<input class=\"w60 text\" type=\"text\" aria-label=\"Precio de flete predeterminado\" maxlength=\"6\" autocomplete=\"off\" value=\"0\" name=\"default[TRANSTYPE][postage]\" data-field=\"postage\">";
	TransTpl += "<em class=\"add-on\">";
	TransTpl += "<i class=\"iconfont\">&#xe65c;<\/i>";
	TransTpl += "<\/em>， Por cada aumento\n";
	TransTpl += "<input class=\"w30 ml5 mr5 text\" type=\"text\" aria-label=\"Por Adición\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"plus\" name=\"default[TRANSTYPE][plus]\">\n";
	TransTpl += "<span class=\"content_1\">Pieza</span>， Aumento del flete\n";
	TransTpl += "<input class=\"w50 ml5 text\" type=\"text\" aria-label=\"Flete adicional\" maxlength=\"6\" autocomplete=\"off\" value=\"0\" data-field=\"postageplus\" name=\"default[TRANSTYPE][postageplus]\">";
	TransTpl += "<em class=\"add-on\">";
	TransTpl += "<i class=\"iconfont\">&#xe65c;<\/i>";
	TransTpl += "<\/em>\n";
	...
	TransTpl += "<label><input class=\"J_BatchCheck\" type=\"checkbox\" aria-label=\"Selección completa\" value=\"\" name=\"\">\n";
	TransTpl += "Selección completa<\/label>\n";
	TransTpl += "&nbsp;<a class=\"J_BatchSet dssc-btn-mini\" href=\"JavaScript:void(0);\">Configuración por lotes<\/a>\n";
	TransTpl += "<a class=\"J_BatchDel dssc-btn-mini\" href=\"JavaScript:void(0);\">Eliminación por lotes<\/a>\n";
	TransTpl += "<\/div>\n";
	...
	TransTpl += "<i class=\"iconfont\">&#xe720;</i>Establecer el flete para la ciudad de la región especificada<\/a>\n";
	TransTpl += "<a class=\"J_ToggleBatch dssc-btn-mini\" style=\"display:none\" href=\"JavaScript:void(0);\">";
	TransTpl += "<i class=\"iconfont\">&#xe720;</i>Operaciones por lotes<\/a>\n";
	TransTpl += "<\/div>\n";
	TransTpl += "<\/div>\n";
	TransTpl += "<\/div>\n";

	SpecialMessage = '';
	SpecialMessage += "<span  error_type=\"area\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>Especifica que la ciudad de la región está vacía o especifica un error<\/span>\n";
	SpecialMessage += "<span  error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>El primer artículo debe introducir un número de 1 a 9999<\/span>\n";
	SpecialMessage += "<span error_type=\"postage\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>La tarifa inicial debe introducir un número de 0.00 a 999.99<\/span>\n";
	SpecialMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>La continuación debe introducir los números 1 a 9999<\/span>\n";
	SpecialMessage += "<span error_type=\"postageplus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>La renovación debe introducir un número de 0,00 a 999,99<\/span>\n";

	DefaultMessage = '';
	DefaultMessage += "<span error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>El primer artículo debe introducir un número de 1 a 9999<\/span>\n";
	DefaultMessage += "<span error_type=\"postage\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>La tarifa inicial debe introducir un número de 0.00 a 999.99<\/span>\n";
	DefaultMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>La continuación debe introducir los números 1 a 9999<\/span>\n";
	DefaultMessage += "<span error_type=\"postageplus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"iconfont\">&#xe64c;<\/i>La renovación debe introducir un número de 0,00 a 999,99<\/span>\n";
	...
	RuleHead += "<th style='padding-left:5px'>Transporte a<\/th>\n";
	RuleHead += "<th class=\"w60\"><span class=\"title_1\">Primer artículo</span>(<span class=\"content_1\">Pieza</span>)<\/th>\n";
	RuleHead += "<th class=\"w110\">Tasa inicial(Peso)<\/th>\n";
	RuleHead += "<th class=\"w60\"><span class=\"title_2\">Continuación</span>(<span class=\"content_1\">Pieza</span>)<\/th>\n";
	RuleHead += "<th class=\"w110\">Renovación(Peso)<\/th>\n";
	RuleHead += "<th class=\"w110\">Operaciones<\/th>\n";
	RuleHead += "<\/tr>\n";
	RuleHead += "<\/thead>\n";
	RuleHead += "<tbody>\n";
	RuleHead += "<\/tbody>\n";
...
//	RuleCell += "<a class=\"dsu-btn2\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">编辑<\/a>\n";
	...
	RuleCell += "<p style=\"display:inline-block\">Zona no añadida<\/p><\/span>\n";
	RuleCell += "<input type=\"hidden\" value=\"\" name=\"areas[TRANSTYPE][CurNum]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w30\" type=\"text\" aria-label=\"Primer artículo\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"start\" name=\"special[TRANSTYPE][CurNum][start]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w60\" type=\"text\" aria-label=\"Tasa inicial\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postage\" name=\"special[TRANSTYPE][CurNum][postage]\"><em class=\"add-on\">\n";
	RuleCell += "<i class=\"iconfont\">&#xe65c;<\/i>\n";
	RuleCell += "<\/em>\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w30\" type=\"text\" aria-label=\"Continuación\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"plus\" name=\"special[TRANSTYPE][CurNum][plus]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w60\" type=\"text\" aria-label=\"Renovación\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postageplus\" name=\"special[TRANSTYPE][CurNum][postageplus]\"><em class=\"add-on\">\n";
	RuleCell += "<i class=\"iconfont\">&#xe65c;<\/i>\n";
	RuleCell += "<\/em>\n";
	RuleCell += "<\/td>\n";
	...
	RuleCell += "<i class=\"iconfont\">&#xe725;<\/i><p>Borrar<\/p>\n";
	RuleCell += "<\/a>\n";
	RuleCell += "<\/span>\n";
	RuleCell += "<span>\n";
	RuleCell += "<a class=\"btn-blue\" data-group=\"nCurNum\" title=\"Editar área de transporte\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">\n";
	RuleCell += "<i class=\"iconfont\">&#xe61d;<\/i><p>Editar<\/p>\n";
	RuleCell += "<\/a>\n";	
	RuleCell += "<\/span>\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<\/tr>\n";
...
/*	为指定地区设置运费,增加一行运费规则*/
	$('.trans-line').on('click','.J_AddRule',function(){
		...
		if ($(this).parent().parent().find('input[type="checkbox"]').css('display') == 'none'){
			$(this).next().css('display','').html('Operaciones por lotes');
		}else{
			$(this).next().css('display','').html('Cancelar lote');
...
//		SelectArea = new Array();
		...
		//返回选择的文本内容
		if (CityText == '')CityText = 'Zona no añadida';
...
//        	obj_parent = $(this).parent().parent().parent();
	...
	$('.trans-line').on('click','.J_BatchSet',function(){
		if($('.tbl-except').find('input:checked').size()==0){
                    layer.alert('Por favor, seleccione el área a establecer por lotes');return false;
		}
...
//		curTrans = $(this).parent().parent();
    ...
    $('.trans-line').on('click', '.J_BatchDel', function () {
        if ($(this).parent().parent().find('.tbl-except').find('input:checked').size() == 0) {
            layer.alert('Por favor, seleccione el área a procesar por lotes');
            return false;
        }
        
        layer.confirm('Confirmar borrado?', {
