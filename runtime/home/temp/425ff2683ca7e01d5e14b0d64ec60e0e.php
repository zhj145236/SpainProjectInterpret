<?php /*a:6:{s:86:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\mall\category\goods_category.html";i:1616221225;s:72:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\base\base_home.html";i:1616221224;s:71:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\base\mall_top.html";i:1617186346;s:74:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\base\mall_header.html";i:1617186851;s:74:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\base\mall_server.html";i:1616221225;s:74:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\base\mall_footer.html";i:1616221225;}*/ ?>
<!doctype html>
<html>
    <head>
...
<div class="dsh-container wrapper">
    ...
    <div class="all-warpper">
        ...
        <div class="all-category-floor" id='cate-<?php echo htmlentities($gc_list['gc_id']); ?>'>
            <div class="floor-top">
                <div class="title"><a class="iconfont toggle" onclick='$(this).parents(".all-category-floor").find(".floor-bot").toggle();$(this).toggleClass("active")'>&#xe689;</a><a href="<?php echo url('Search/index',['cate_id'=>$gc_list['gc_id']]); ?>"><?php echo htmlentities($gc_list['gc_name']); ?></a></div>
            </div>
            ...
            <div class="floor-bot">
                <div class="floor-category-list"> 
                    ...
                    <dl>
                        <dt> <a href="<?php echo url('Search/index',['cate_id'=>$gc_list2['gc_id']]); ?>" ><i><?php if(isset($gc_list2['pic'])): ?><img src='<?php echo htmlentities($gc_list2['pic']); ?>'><?php else: ?><span class="iconfont">&#xe709;</span><?php endif; ?></i><p><?php echo htmlentities($gc_list2['gc_name']); ?></p></a> </dt>
                    </dl>
                    <?php endforeach; ?>
                </div>
            </div>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_607415a9cf38b = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_607415a9cf38b)==0 ) : echo "" ;else: foreach($_607415a9cf38b as $key=>$art): ?>
        <dl> 
