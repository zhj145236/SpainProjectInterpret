<?php /*a:3:{s:74:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\mall\login\login.html";i:1617194866;s:71:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\base\mall_top.html";i:1617186346;s:74:"D:\wwwroot\fyshops.domibuy.com\app\home\view\default\base\mall_footer.html";i:1616221225;}*/ ?>
<!doctype html>
<html>
    <head>
            ...
            <div class="mc">
                <form id="login_normal_form" method="post" action="<?php echo url('Login/login'); ?>">
                    ...
                    <?php if(config('ds_config.captcha_status_login') == '1'): ?>
                     <div class="item">
                        <div class="text-area">
                            <div class="iconfont ico">&#xe67b;</div>
                            <input type="text" id="captcha_normal" name="captcha_normal" class="text" style="width:140px;float:left" placeholder="<?php echo htmlentities(lang('login_register_code')); ?>" tabindex="2" maxlength="4"/>
                            <span class="span">
                ...
                <form id="login_mobile_form" method="post" action="<?php echo url('Connectsms/login'); ?>" style="display:none">
                    ...
                    <div class="item">
                        <div class="text-area">
                            <div class="iconfont ico">&#xe67b;</div>
                            <input type="text" oninput="value=value.replace(/[^\d]/g,'')"  id="sms_captcha" name="sms_captcha" class="text" placeholder="<?php echo htmlentities(lang('login_mobile_verification_code')); ?>" tabindex="2" style="width:140px;float:left" maxlength="6"/>
